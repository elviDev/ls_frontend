  ...
  try {
    ...
    const updatedEvent = await prisma.$transaction(async (tx: any) => {
      ...
      if (data.endTime !== undefined)
        scheduleData.endTime = data.endTime ? new Date(data.endTime) : null;
      ...
      if (data.virtualLink !== undefined)
        eventData.virtualLink = data.virtualLink;
      ...
      if (data.requiresRSVP !== undefined)
        eventData.requiresRSVP = data.requiresRSVP;
      ...
      if (data.galleryUrls !== undefined)
        eventData.galleryUrls = data.galleryUrls;
      if (data.contactEmail !== undefined)
        eventData.contactEmail = data.contactEmail;
      if (data.contactPhone !== undefined)
        eventData.contactPhone = data.contactPhone;
      if (data.contactPerson !== undefined)
        eventData.contactPerson = data.contactPerson;
      if (data.facebookEvent !== undefined)
        eventData.facebookEvent = data.facebookEvent;
      if (data.twitterEvent !== undefined)
        eventData.twitterEvent = data.twitterEvent;
      if (data.linkedinEvent !== undefined)
        eventData.linkedinEvent = data.linkedinEvent;
      if (data.coOrganizers !== undefined)
        eventData.coOrganizers = data.coOrganizers;

...
export default function ChaptersPage() {
  ...
  const { currentAudiobook, setCurrentAudiobook } = useAudiobookStore();
  const { data: chapters = [], isLoading } = useAudiobookChapters(
    audiobookId
  ) as { data: Chapter[]; isLoading: boolean };
      ...
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The audiobook ID is missing or invalid.
          </p>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground">
            {currentAudiobook?.title} • {chapters.length} chapters
          </p>
        </div>
        <Button
          onClick={() =>
            router.push(`/dashboard/audiobooks/${audiobookId}/chapters/new`)
          }
        >
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <Button
                ...
                onClick={() =>
                  router.push(
                    `/dashboard/audiobooks/${audiobookId}/chapters/new`
                  )
                }
              >
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() =>
                                router.push(
                                  `/dashboard/audiobooks/${audiobookId}/chapters/${chapter.id}/edit`
                                )
                              }
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                router.push(
                                  `/dashboard/audiobooks/${audiobookId}/chapters/${chapter.id}`
                                )
                              }
                            >
                            ...
                            {chapter.status === "DRAFT" && (
                              <DropdownMenuItem
                                onClick={() =>
                                  handleStatusChange(chapter.id, "PUBLISHED")
                                }
                              >
                            ...
                            {chapter.status === "PUBLISHED" && (
                              <DropdownMenuItem
                                onClick={() =>
                                  handleStatusChange(chapter.id, "ARCHIVED")
                                }
                              >
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    {chapter.title}"? This action cannot be
                                    undone.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>

        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              {(podcast as any).youtubePlaylistUrl && (
                <div className="mt-4 pt-4 border-t">
                  <a
                    href={(podcast as any).youtubePlaylistUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 w-full justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      className="h-4 w-4 fill-[#FF0000]"
                    >

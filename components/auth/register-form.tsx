      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="username">
              {t("auth.username")} {userType === "staff" && "*"}
            </Label>
            <Input
              id="username"
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="HOST">
                    {t("register.roles.HOST")}
                  </SelectItem>
                  <SelectItem value="CO_HOST">
                    {t("register.roles.CO_HOST")}
                  </SelectItem>
                  <SelectItem value="PRODUCER">
                    {t("register.roles.PRODUCER")}
                  </SelectItem>
                  <SelectItem value="SOUND_ENGINEER">
                    {t("register.roles.SOUND_ENGINEER")}
                  </SelectItem>
                  <SelectItem value="CONTENT_MANAGER">
                    {t("register.roles.CONTENT_MANAGER")}
                  </SelectItem>
                  <SelectItem value="TECHNICAL_SUPPORT">
                    {t("register.roles.TECHNICAL_SUPPORT")}
                  </SelectItem>
                  <SelectItem value="ADMIN">
                    {t("register.roles.ADMIN")}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
        ...
        >
          {registerMutation.isPending
            ...
            : userType === "user"
              ? t("register.registerAsUser")
              : t("register.registerAsStaff")}
        </Button>
      </form>

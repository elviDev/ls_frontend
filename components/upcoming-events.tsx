    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3].map((i) => (
          <Card
            key={i}
            className="overflow-hidden animate-pulse dark:bg-slate-900"
          >
            <div className="bg-gray-200 dark:bg-slate-800 p-4 h-16"></div>
            <CardContent className="p-6">
              <div className="h-4 bg-gray-200 dark:bg-slate-800 rounded mb-4"></div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {events.map((event) => (
        <Card
          key={event.id}
          className="overflow-hidden hover:shadow-md transition-all dark:bg-slate-900"
        >
          <div className="bg-gradient-to-r from-brand-600 to-brand-800 dark:from-slate-800 dark:to-slate-900 p-4">
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-center text-sm dark:text-gray-300">
                <MapPin className="h-4 w-4 mr-2 text-muted-foreground dark:text-gray-400" />
                <span>
                  {event.isVirtual
                    ? "Virtual Event"
                    : event.venue ||
            ...
            <Button className="w-full bg-primary dark:bg-cyan-500 dark:text-darkTeam hover:bg-primary dark:hover:bg-cyan-400">
              {event.isPaid
                ? `$${event.ticketPrice} - Register`
                : "Register Now"}
            </Button>
          </CardContent>
        </Card>
